    ...
    <div className='assignNotice'>
        ...
        <div className="assignNoticeContainer">
          ...
          <form action="#" method="post">
            ...
            <input type="text" id='title' placeholder="Title" onChange={handleChangeText}/>

            <label htmlFor="noticeType">Notice Type: </label>
            <input type="text" id='noticeType' placeholder="Title" onChange={handleChangeText}/>
            
            <label htmlFor="description">Description</label>
            <textarea name="" id="description" cols="500" rows="15" placeholder='description' onChange={handleChangeText}></textarea>
            ...
            <button type="submit" onClick={handleClick}>Submit Notice</button>
          </form>
        </div>
    </div>
  )
